...
public class LogConfig {
     ...
     */
    public LogConfig(final String fileName, final Level rootLevel) {
        this(fileName);
     ...
     */
    public LogConfig(final String fileName, final Level rootLevel, final String filePattern) {
        this(fileName);
        setRootLevel(rootLevel);
     ...
     * @param rootLevel Log level for the root logger
     */
    public LogConfig(final String fileName, final int maxBackupSize,
